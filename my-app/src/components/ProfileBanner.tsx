  ...
  return (
    <section id="profile" className="relative w-full h-screen flex flex-col md:flex-row overflow-hidden items-stretch">
      ...
      <div className="hidden md:block absolute left-0 top-0 w-1/2 h-full pointer-events-none z-50">
        ...
        <StickerPeel
          className="absolute top-[6vh] left-[3vw] pointer-events-auto"
        ...
        <StickerPeel
          className="absolute top-[6vh] right-[3vw] pointer-events-auto"
        ...
        <StickerPeel
          className="absolute bottom-[6vh] left-[3vw] pointer-events-auto"
        ...
        <StickerPeel
          className="absolute bottom-[6vh] right-[3vw] pointer-events-auto"
